                ...
                <div class="mt-4 text-sm text-gray-500">
                  <form
                    ...
                    <!-- <input
                      ...
                      required /> -->
                      <select class="block w-full ring-0 outline-none py-2 text-gray-800 border-b placeholder:text-gray-400 md:text-4xl" required name="transfer_to">
                        <option value="" class="text-gray-400">Select Recipient's Email Address</option>
